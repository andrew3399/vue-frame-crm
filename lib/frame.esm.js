...
exports.default = {
   ...
   */
    ...
    */
			var accessToken = sessionStorage.get('access_token');
			var refreshToken = sessionStorage.get('refresh_token');
			var sessionTime = sessionStorage.get('session-time');
    ...
    */
     ...
     */
       ...
       */
						case 401:
							...
							var msg = {
								client_id: _this.authorization.client_id,
								redirect_uri: encodeURIComponent(_this.authorization.redirect_uri),
								state: (0, _utils.uuid)(6, 16)
							};
							window.location.href = _this.authorization.authorizeUri + '?client_id=' + msg.client_id + '&redirect_uri=' + msg.redirect_uri + '&response_type=code&scope=read&state=' + msg.state;
							break;
					}
				}
			});
	...
	created: function () {
		var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
			...
			var that, accessToken, refreshToken, fetchLang;
        ...
        */
							...
							accessToken = sessionStorage.get('access_token');
							refreshToken = sessionStorage.get('refresh_token');
         ...
         */
								_this2.$nextTick(function () {
									...
									var queryName = (0, _utils.getQueryData)(res.data, 'menuId', 'menuPid', route, 'menuName');
									_this2.queryActiveMenu = queryName.name;
									_this2.queryOpenName = queryName.names;
									_this2.$router.push({ path: route });
								});
								/**
         ...
         */
          ...
          */
										case 401:
											var _accessToken = sessionStorage.get('access_token');
											var _refreshToken = sessionStorage.get('refresh_token');
											if (!_accessToken || !_refreshToken) return;
											var msg = {
												client_id: _this2.authorization.client_id,
												redirect_uri: encodeURIComponent(_this2.authorization.redirect_uri),
												state: (0, _utils.uuid)(6, 16)
											};
											window.location.href = _this2.authorization.authorizeUri + '?client_id=' + msg.client_id + '&redirect_uri=' + msg.redirect_uri + '&response_type=code&scope=read&state=' + msg.state;
											break;
									}
								}
							});
         ...
         */
          ...
          */
										case 401:
											var _accessToken2 = sessionStorage.get('access_token');
											var _refreshToken2 = sessionStorage.get('refresh_token');
											if (!_accessToken2 || !_refreshToken2) return;
											var msg = {
												client_id: _this2.authorization.client_id,
												redirect_uri: encodeURIComponent(_this2.authorization.redirect_uri),
												state: (0, _utils.uuid)(6, 16)
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.bullet.bulletinTitle))]), _vm._v(" "), _c('p', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: "text-left n-l-nr",
      domProps: {
        "innerHTML": _vm._s(item.bulletinContent)
      }
    }), _vm._v(" "), _c('p', {
      staticClass: "text-left n-l-time"
