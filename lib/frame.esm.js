    ...
    */
	...
	created: function () {
		var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
			...
			var path, routeArr, parsed, that, accessToken, refreshToken, fetchLang;
        ...
        * 获取所有URL query 并存储
        */
							parsed = _queryString2.default.parse(window.location.search);
        ...
        */
         ...
         */
								_this2.$nextTick(function () {
									...
									var querys = localStorage.get('query-key');
									if (route && !routeArr2.includes(decodeURIComponent(path))) {
										var query = JSON.parse(querys);
										_this2.$router.push({ path: decodeURIComponent(route), query: query });
	...
	methods: {
		getBulletinById: function getBulletinById() {
			...
			this.instance.get(this.authorization.bulletinByIdUri, {
				...
				_this.bullet.bulletinContent = res.data.bulletinContent.replace(/(\\n)/g, '');
			}).catch(function (res) {
				_this.$Message.warning(_this.$t('frame.warning'));
			});
		}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: ['layout-logo-min-min', {
      'span-hide': _vm.isOpen === false
    }]
  }, [_c('span', [_c('img', {
    staticClass: "layout-logo-min-img",
    attrs: {
