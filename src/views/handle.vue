                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="col-6">
                                <t-input v-model="fromItem.title"></t-input>
                            </div>
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="col-6">
                                <t-input v-model="fromItem.applyStaffId"></t-input>
                            </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="col-6">
                                <t-date-picker style="width:100%;"></t-date-picker>
                            </div>
                            </div>
                        </div>
                    </div>
...
export default{
   data() {
    ...
    computed: {
            ...
            columns() {
                return [
                    ...
                    {
                        title: this.$t('handle_local.handle.applicant'),
                        key: 'workflowCreateStaffId',
                    },
                    {
    ...
    methods: {
        ...
        changePage(pageNum){
            let that = this
           that.fromItem.pageNum = pageNum == null ? 1 : pageNum;
